...
const EmailListModal = ({
  ...
  const {
    ...
    // url: `https://uat-api-dev.mfilterit.net/v1/app/reporting_tool/create_mailing_list`,
    url: process.env.NEXT_PUBLIC_APP_PERF + `reporting_tool/reengagement/create_mailing_list`,
    method: "POST",
    manual: true,
    onSuccess: () => {
      onClose();
  ...
  const {
    ...
    // url: `https://uat-api-dev.mfilterit.net/v1/app/reporting_tool/edit_mailing_list`,
    url: process.env.NEXT_PUBLIC_APP_PERF + `reporting_tool/reengagement/edit_mailing_list`,
    method: "POST",
    manual: true,
    onSuccess: () => {
      onClose();
...
const mailingList: React.FC = () => {
  ...
  const { result: updateStatusMutation } = useApiCall<{
    ...
    // url: `https://uat-api-dev.mfilterit.net/v1/app/reporting_tool/status_change`,
    url: process.env.NEXT_PUBLIC_APP_PERF + `reporting_tool/reengagement/status_change`,
    method: "POST",
    manual: true,
    onSuccess: (response) => {
        setToastData({
  ...
  const { result: mailingListResult, loading: mailingListLoading } =
    useApiCall<{
      ...
      url: process.env.NEXT_PUBLIC_APP_PERF + `reporting_tool/reengagement/list_all_mailing_lists`,
      method: "POST",
      manual: true,
      onSuccess: (data) => {
