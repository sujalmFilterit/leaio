...
const CSS_CLASSES = {
  ...
  FILTER_PILL: "group relative flex items-center gap-2 rounded-full border border-border/50 bg-gradient-to-br from-background via-background to-muted/20 px-4 py-2 text-sm font-medium text-foreground shadow-sm backdrop-blur-sm transition-all duration-300 hover:scale-105  hover:shadow-md  active:scale-100",
  ...
  SEARCH_INPUT: "rounded-br-none rounded-tr-none text-small-font",
  SEARCH_BUTTON: "w-10 h-10 rounded-bl-none rounded-tl-none",
  FILTER_LIST_CONTAINER: "relative flex flex-1 min-h-0",
  SCROLL_CONTAINER: "flex-1 overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent min-h-0",
  GROUP_HEADER: "flex items-center bg-gray-50 px-2 py-1.5 rounded-md mb-2",
  GROUP_ITEMS: "pl-6 border-l-2 border-gray-200",
  GROUP_ITEM: "flex items-center hover:bg-gray-50 px-2 py-1 rounded",
  ALPHABET_HEADER: "sticky top-0 bg-background py-1 text-subBody font-semibold",
  ALPHABET_ITEM: "flex items-center py-1",
  NAVIGATION_CONTAINER: "flex flex-col items-center py-2 border-l overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent",
  NAVIGATION_BUTTON: "text-xs px-1 py-0.5 rounded hover:bg-muted",
  ...
  NO_RESULTS: "p-4 text-center text-gray-500 text-sm",
} as const;
